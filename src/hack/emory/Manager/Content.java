...
/**
 * This class is the content manager for Indigo. Call
 * {@link Content#getImage(ImageData)},
 * {@link Content#getAnimation(AnimationData)}, or
 * {@link Content#getSound(SoundData)} with the respective static image or
 * animation data to get and cache the content, if it hasn't already. <br>
 * <br>
 * Call {@link #dispose()} whenever the stage is changed. To prevent RAM
 * hogging.<br>
 * <br>
 * Conventions should dictate that {@link #dispose()} can be called at any given
 * time, so images and animations should be reattained from the cache every
 * frame.
 */
public class Content {
	...
	public static AnimationData PLAYER_MOVE_DOWN = new AnimationData("/images/sprites/player/move_down.png", 128, 128,
			4);
	public static AnimationData PLAYER_MOVE_LEFT = new AnimationData("/images/sprites/player/move_left.png", 128, 128,
			4);
	public static AnimationData PLAYER_MOVE_RIGHT = new AnimationData("/images/sprites/player/move_right.png", 128, 128,
			4);

	public static AnimationData PLAYER_IDLE_UP = new AnimationData("/images/sprites/player/idle_up.png", 128, 128, 2);
	public static AnimationData PLAYER_IDLE_DOWN = new AnimationData("/images/sprites/player/idle_down.png", 128, 128,
			2);
	public static AnimationData PLAYER_IDLE_LEFT = new AnimationData("/images/sprites/player/idle_left.png", 128, 128,
			2);
	public static AnimationData PLAYER_IDLE_RIGHT = new AnimationData("/images/sprites/player/idle_right.png", 128, 128,
			2);
	...
	/**
	 * @param ad
	 *            The ImageData to retrieve the image from. Should be attained
	 *            from {@link Content}.
	...
	/**
	 * @param ad
	 *            The AnimationData to retrieve the animation from. Should be
	 *            attained from {@link Content}.
	...
	/**
	 * @param sd
	 *            The SoundData to retrieve the sound from. Should be attained
	 *            from {@link Content}
	...
	/**
	 * Clears the image, animation, and sound cache. To be called between
	 * stages, but should conventionally be able to be called at any time.
	 */
